...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    // everything pass this point is Step Counter code (untested yet)
    ...
    // this area might be the cause of an error if its constantly crashing
    private void onGetAllStepSuccess(List<Step> steps) {
        stepList.clear();
        stepList.addAll(steps);

        // if its crashes, comment out this line and see if it runs
        // updating the UI this way might lock up the thread
        stepTextView.setText(mStep.getNumStep());
    }
